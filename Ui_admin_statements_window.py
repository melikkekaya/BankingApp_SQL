...
"   ")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\musab\\OneDrive\\Belgeler\\GitHub\\BankingApp_SQL\\icons/back-arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(40, 90, 394, 140))
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\musab\\OneDrive\\Belgeler\\GitHub\\BankingApp_SQL\\icons/filter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, admin_statements_window):
        ...
        self.ADstatementswdw_combobox_Ttype.setItemText(1, _translate("admin_statements_window", "All excl. Login"))
        self.ADstatementswdw_combobox_Ttype.setItemText(2, _translate("admin_statements_window", "Deposit Money"))
        self.ADstatementswdw_combobox_Ttype.setItemText(3, _translate("admin_statements_window", "Withdraw Money"))
        self.ADstatementswdw_combobox_Ttype.setItemText(4, _translate("admin_statements_window", "Internal Money Transfer"))
        self.ADstatementswdw_combobox_Ttype.setItemText(5, _translate("admin_statements_window", "External Money Transfer"))
        self.ADstatementswdw_combobox_Ttype.setItemText(6, _translate("admin_statements_window", "Money Received"))
        self.ADstatementswdw_combobox_Ttype.setItemText(7, _translate("admin_statements_window", "Login"))
