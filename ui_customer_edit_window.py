...
class Ui_Customer_infoEdit_window(object):
    def setupUi(self, Customer_infoEdit_window):
        ...
        self.cseditwdw_lbl_headingPers.setGeometry(QtCore.QRect(90, 130, 321, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        ...
        self.cseditwdw_lbl_headingCntc.setGeometry(QtCore.QRect(90, 290, 321, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.cseditwdw_lbl_email.setGeometry(QtCore.QRect(90, 360, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.cseditwdw_lbl_headingAcc.setGeometry(QtCore.QRect(90, 450, 321, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.cseditwdw_lbl_password.setGeometry(QtCore.QRect(90, 520, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(16)
        font.setBold(True)
...
"   ")
        ...
        self.cseditwdw_linedit_CSname_show.setGeometry(QtCore.QRect(220, 210, 151, 31))
        ...
        self.cseditwdw_linedit_CSemail_show.setGeometry(QtCore.QRect(220, 370, 151, 31))
