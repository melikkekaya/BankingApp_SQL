...
"")
        ...
        self.csmainwdw_btn_option = QtWidgets.QPushButton(self.centralwidget)
        self.csmainwdw_btn_option.setGeometry(QtCore.QRect(110, 420, 381, 71))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        self.csmainwdw_btn_option.setFont(font)
        self.csmainwdw_btn_option.setStyleSheet("QPushButton{\n"
"    background-color: rgb(0, 100, 148);\n"
"\n"
"border:2px solid rgb(0, 150, 199);\n"
"border-radius:20px;\n"
...
"     border:2px solid rgb(0, 150, 199);\n"
"}")
        self.csmainwdw_btn_option.setObjectName("csmainwdw_btn_option")
    ...
    def retranslateUi(self, customer_main_window):
        ...
        self.csmainwdw_btn_option.setText(_translate("customer_main_window", "OPTİONS"))
