...
"   ")
    ...
    def retranslateUi(self, admin_statements_window):
        ...
        self.ADstatementswdw_combobox_Ttype.setItemText(1, _translate("admin_statements_window", "Deposit"))
        self.ADstatementswdw_combobox_Ttype.setItemText(2, _translate("admin_statements_window", "Withdraw"))
        self.ADstatementswdw_combobox_Ttype.setItemText(3, _translate("admin_statements_window", "Bank Transfer"))
        self.ADstatementswdw_combobox_Ttype.setItemText(4, _translate("admin_statements_window", "EFT"))
        self.ADstatementswdw_combobox_Ttype.setItemText(5, _translate("admin_statements_window", "Login"))
