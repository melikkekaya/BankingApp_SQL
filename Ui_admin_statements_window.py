...
"   ")
        ...
        self.ADstatementswdw_btn_search.setGeometry(QtCore.QRect(200, 260, 75, 23))
        ...
        self.ADstatementswdw_lbl_filter_date_Ttype.setGeometry(QtCore.QRect(20, 220, 101, 16))
        ...
        self.ADstatementswdw_lbl_filter_amount.setGeometry(QtCore.QRect(250, 190, 47, 14))
        ...
        self.ADstatementswdw_lbl_filter_name.setGeometry(QtCore.QRect(260, 160, 47, 14))
        ...
        self.ADstatementswdw_lnedit_amount.setGeometry(QtCore.QRect(300, 190, 113, 20))
        ...
        self.ADstatementswdw_combobox_Ttype.setGeometry(QtCore.QRect(130, 220, 91, 22))
        ...
        self.ADstatementswdw_lnedit_name.setGeometry(QtCore.QRect(300, 160, 113, 20))
        ...
        self.ADstatementswdw_tableWidget.setGeometry(QtCore.QRect(20, 300, 531, 211))
        ...
        self.ADstatementswdw_dateEdit_start = QtWidgets.QDateEdit(self.centralwidget)
        self.ADstatementswdw_dateEdit_start.setGeometry(QtCore.QRect(120, 130, 110, 22))
        self.ADstatementswdw_dateEdit_start.setObjectName("ADstatementswdw_dateEdit_start")
        self.ADstatementswdw_dateEdit_end = QtWidgets.QDateEdit(self.centralwidget)
        self.ADstatementswdw_dateEdit_end.setGeometry(QtCore.QRect(290, 130, 110, 22))
        self.ADstatementswdw_dateEdit_end.setObjectName("ADstatementswdw_dateEdit_end")
        self.ADstatementswdw_lbl_filter_email = QtWidgets.QLabel(self.centralwidget)
        self.ADstatementswdw_lbl_filter_email.setGeometry(QtCore.QRect(70, 190, 47, 14))
        self.ADstatementswdw_lbl_filter_email.setObjectName("ADstatementswdw_lbl_filter_email")
        self.ADstatementswdw_lnedit_email = QtWidgets.QLineEdit(self.centralwidget)
        self.ADstatementswdw_lnedit_email.setGeometry(QtCore.QRect(120, 190, 113, 20))
    ...
    def retranslateUi(self, admin_statements_window):
        ...
        self.ADstatementswdw_combobox_Ttype.setItemText(4, _translate("admin_statements_window", "External Money Transfer"))
        self.ADstatementswdw_combobox_Ttype.setItemText(5, _translate("admin_statements_window", "Money Received"))
        self.ADstatementswdw_combobox_Ttype.setItemText(6, _translate("admin_statements_window", "Login"))
