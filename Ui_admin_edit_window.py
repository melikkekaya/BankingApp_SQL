...
"}")
        ...
        self.ad_edit_wdw_cs_name_lnedit_2 = QtWidgets.QLineEdit(self.gridLayoutWidget_3)
        self.ad_edit_wdw_cs_name_lnedit_2.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ad_edit_wdw_cs_name_lnedit_2.sizePolicy().hasHeightForWidth())
        self.ad_edit_wdw_cs_name_lnedit_2.setSizePolicy(sizePolicy)
        self.ad_edit_wdw_cs_name_lnedit_2.setMinimumSize(QtCore.QSize(250, 50))
        self.ad_edit_wdw_cs_name_lnedit_2.setMaximumSize(QtCore.QSize(280, 50))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.ad_edit_wdw_cs_name_lnedit_2.setFont(font)
        self.ad_edit_wdw_cs_name_lnedit_2.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.ad_edit_wdw_cs_name_lnedit_2.setObjectName("ad_edit_wdw_cs_name_lnedit_2")
        self.gridLayout_4.addWidget(self.ad_edit_wdw_cs_name_lnedit_2, 0, 2, 1, 1)
