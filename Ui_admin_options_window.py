...
class Ui_admin_options_window(object):
    def setupUi(self, admin_options_window):
        ...
        self.adminoptwdw_lbl_heading.setGeometry(QtCore.QRect(30, 50, 541, 81))
        font = QtGui.QFont()
        ...
        self.adminwdw_btn_createcs.setGeometry(QtCore.QRect(160, 190, 260, 71))
        font = QtGui.QFont()
...
"}")
        ...
        self.adminwdw_btn_editinf.setGeometry(QtCore.QRect(160, 300, 261, 71))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(16)
        font.setBold(True)
...
"}")
        ...
        self.adminwdw_btn_bankstt.setGeometry(QtCore.QRect(160, 410, 261, 71))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(16)
        font.setBold(True)
...
"}")
        ...
        self.adminwdw_btn_back = QtWidgets.QPushButton(self.centralwidget)
        self.adminwdw_btn_back.setGeometry(QtCore.QRect(100, 590, 150, 50))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.adminwdw_btn_back.setFont(font)
        self.adminwdw_btn_back.setStyleSheet("QPushButton {\n"
...
"    \n"
"   ")
        self.adminwdw_btn_back.setObjectName("adminwdw_btn_back")
...
"   ")
    ...
    def retranslateUi(self, admin_options_window):
        ...
        self.adminwdw_btn_back.setText(_translate("admin_options_window", "Back"))
